...
abstract class CheeseDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun get(context: Context): CheeseDatabase {
            if (instance == null) {
                instance = Room.databaseBuilder(context.applicationContext, CheeseDatabase::class.java, "chess.db")
        ...
        private fun fillInDb(context: Context) {
            ioThread {
                get(context).cheeseDao().insert(CHEESE_DATA.map { Cheese(name = it) })
            }
        }
    }
}
